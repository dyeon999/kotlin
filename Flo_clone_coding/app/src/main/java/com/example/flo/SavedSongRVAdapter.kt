...
class SavedSongRVAdapter() :
    ...
    override fun onBindViewHolder(holder: SavedSongRVAdapter.ViewHolder, position: Int) {
        ...
        holder.binding.itemMusicMore.setOnClickListener {
    ...
    inner class ViewHolder(val binding: ItemMusiclistBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(song: Song){
            binding.itemMusicAlbumIv.setImageResource(song.coverImg!!)
            binding.itemMusicTitleTv.text = song.title
            binding.itemMusicSingerTv.text = song.singer
        }
    }
}